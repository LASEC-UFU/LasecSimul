...
export const defaultComponentCatalog: WebviewComponentCatalogEntry[] = [
  ...
  { typeId: "connectors.bus", label: "Barramento", category: "Conectores", folderPath: ["Conectores"], workspaceSection: "misc", icon: "bus", pinCount: 1, defaultProperties: {} },
  ...
  { typeId: "connectors.tunnel", label: "Tunel", category: "Conectores", folderPath: ["Conectores"], workspaceSection: "misc", icon: "tunel", pinCount: 1, pinIds: ["pin"], defaultProperties: {} },
  { typeId: "connectors.socket", label: "Soquete", category: "Conectores", folderPath: ["Conectores"], workspaceSection: "misc", icon: "socket", graphical: true, pinCount: 8, defaultProperties: {} },
  { typeId: "connectors.header", label: "Cabecalho", category: "Conectores", folderPath: ["Conectores"], workspaceSection: "misc", icon: "header", graphical: true, pinCount: 8, defaultProperties: {} },
  { typeId: "graphics.image", label: "Imagem", category: "Grafico", folderPath: ["Grafico"], workspaceSection: "misc", icon: "graphic-image", graphical: true, pinCount: 0, defaultProperties: { path: "" } },
  { typeId: "graphics.text", label: "Texto", category: "Grafico", folderPath: ["Grafico"], workspaceSection: "misc", icon: "graphic-text", graphical: true, pinCount: 0, defaultProperties: { text: "Text" } },
  { typeId: "graphics.rectangle", label: "Retangulo", category: "Grafico", folderPath: ["Grafico"], workspaceSection: "misc", icon: "graphic-rectangle", graphical: true, pinCount: 0, defaultProperties: {} },
  { typeId: "graphics.ellipse", label: "Elipse", category: "Grafico", folderPath: ["Grafico"], workspaceSection: "misc", icon: "graphic-ellipse", graphical: true, pinCount: 0, defaultProperties: {} },
  { typeId: "graphics.line", label: "Linha", category: "Grafico", folderPath: ["Grafico"], workspaceSection: "misc", icon: "graphic-line", graphical: true, pinCount: 0, defaultProperties: {} },
  ...
  { typeId: "plc.instance", label: "PLC IEC 61131-3", category: "Controle", folderPath: ["PLC IEC 61131-3"], workspaceSection: "process", icon: "package", pinCount: 0,
  ...
  { typeId: "protocol.modbus.server", label: "Servidor Modbus", category: "Process", folderPath: ["Protocolos Industriais", "Modbus"], workspaceSection: "process", icon: "package", pinCount: 2, pinIds: ["value", "gnd"], defaultProperties: { channel: "modbus-1", enabled: true, scanPeriodMs: 100, timeoutMs: 1000, unitId: 1, area: "holdingRegister", address: 0, scale: 0.001, offset: 0 } },
  { typeId: "protocol.modbus.client", label: "Cliente Modbus", category: "Process", folderPath: ["Protocolos Industriais", "Modbus"], workspaceSection: "process", icon: "package", pinCount: 2, pinIds: ["value", "gnd"], defaultProperties: { channel: "modbus-1", enabled: true, scanPeriodMs: 100, timeoutMs: 1000, unitId: 1, area: "holdingRegister", address: 0, scale: 0.001, offset: 0 } },
  { typeId: "protocol.hart.transmitter", label: "Transmissor HART", category: "Process", folderPath: ["Protocolos Industriais", "HART"], workspaceSection: "process", icon: "package", pinCount: 2, pinIds: ["value", "gnd"], defaultProperties: { channel: "hart-1", enabled: true, scanPeriodMs: 100, timeoutMs: 1000, pollingAddress: 0, uniqueId: "0011223344", tag: "TIC101", unit: "V" } },
  { typeId: "protocol.hart.communicator", label: "Comunicador HART", category: "Process", folderPath: ["Protocolos Industriais", "HART"], workspaceSection: "process", icon: "package", pinCount: 2, pinIds: ["value", "gnd"], defaultProperties: { channel: "hart-1", enabled: true, scanPeriodMs: 100, timeoutMs: 1000, pollingAddress: 0, uniqueId: "0011223344", tag: "TIC101", unit: "V", hartCommand: "1" } },
  { typeId: "protocol.hart.serial", label: "HART Serial", category: "Process", folderPath: ["Protocolos Industriais", "HART"], workspaceSection: "process", icon: "terminal", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "COM1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "HART", unit: "V", baudRate: 1200 } },
  { typeId: "protocol.hart.udp", label: "HART UDP", category: "Process", folderPath: ["Protocolos Industriais", "HART"], workspaceSection: "process", icon: "globe", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "127.0.0.1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "HART", unit: "V", udpPort: 5094 } },
  { typeId: "protocol.hart.device.smar_ld301", label: "SMAR LD301", category: "Process", folderPath: ["Protocolos Industriais", "HART"], workspaceSection: "process", icon: "smar-ld301", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "COM1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "LD301", unit: "kPa", baudRate: 1200, profileId: "lasecsimul.hart.smar-ld301", hartVariablesJson: "[{\"id\":\"PV\",\"name\":\"Pressao Diferencial\",\"unit\":\"kPa\",\"value\":0,\"role\":\"PV\",\"type\":\"Float32\",\"direction\":\"Input\",\"classification\":65,\"family\":5,\"writable\":false,\"lowerRangeValue\":0,\"upperRangeValue\":25,\"pressure\":{\"pressureUnitCode\":12}}]" } },
  { typeId: "protocol.hart.device.smar_tt301", label: "SMAR TT301", category: "Process", folderPath: ["Protocolos Industriais", "HART"], workspaceSection: "process", icon: "smar-tt301", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "COM1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "TT301", unit: "C", baudRate: 1200, profileId: "lasecsimul.hart.smar-tt301", hartVariablesJson: "[{\"id\":\"PV\",\"name\":\"Temperatura\",\"unit\":\"C\",\"value\":25,\"role\":\"PV\",\"type\":\"Float32\",\"direction\":\"Input\",\"classification\":64,\"family\":4,\"writable\":false,\"lowerRangeValue\":-50,\"upperRangeValue\":200,\"temperature\":{\"probeType\":0,\"numberOfWires\":3}}]" } },
  { typeId: "protocol.hart.device.smar_fy301", label: "SMAR FY301", category: "Process", folderPath: ["Protocolos Industriais", "HART"], workspaceSection: "process", icon: "smar-fy301", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "COM1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "FY301", unit: "%", baudRate: 1200, profileId: "lasecsimul.hart.smar-fy301", hartVariablesJson: "[{\"id\":\"PV\",\"name\":\"Posicao Real\",\"unit\":\"%\",\"value\":0,\"role\":\"PV\",\"type\":\"Float32\",\"direction\":\"Input\",\"classification\":91,\"family\":6,\"writable\":false,\"lowerRangeValue\":0,\"upperRangeValue\":100},{\"id\":\"setpoint\",\"name\":\"Setpoint de Posicao\",\"unit\":\"%\",\"value\":0,\"role\":\"SV\",\"type\":\"Float32\",\"direction\":\"Output\",\"classification\":91,\"family\":6,\"writable\":true,\"lowerRangeValue\":0,\"upperRangeValue\":100}]" } },
