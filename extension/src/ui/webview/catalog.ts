...
export const defaultComponentCatalog: WebviewComponentCatalogEntry[] = [
  ...
  { typeId: "peripherals.udp", label: "HART UDP", category: "Process", folderPath: ["peripherals"], workspaceSection: "misc", icon: "globe", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "127.0.0.1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "HART", unit: "V", udpPort: 5094, hart_device_id: "" } },
