...
export const defaultComponentCatalog: WebviewComponentCatalogEntry[] = [
  ...
  { typeId: "protocol.hart.serial", label: "HART Serial", category: "Process", folderPath: ["Process", "Protocolos Industriais", "HART"], workspaceSection: "process", icon: "terminal", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "COM1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "HART", unit: "V", baudRate: 1200 } },
  { typeId: "protocol.hart.udp", label: "HART UDP", category: "Process", folderPath: ["Process", "Protocolos Industriais", "HART"], workspaceSection: "process", icon: "globe", pinCount: 0, defaultProperties: { bus: "hart-1", endpoint: "127.0.0.1", enabled: true, pollingAddress: 0, uniqueId: "029EB1", tag: "HART", unit: "V", udpPort: 5094 } },
