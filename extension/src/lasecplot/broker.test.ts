...
class MemoryTransport implements LasecPlotTransport {
  ...
  async write(_componentId: string, data: Uint8Array): Promise<void> { this.writes.push(data); }
}
const registration = { id: "lasecsimul://workspace/w/simulation/s/lasecplot/component-42", componentId: "component-42", name: "Temperatura", projectId: "w", simulationId: "s", baudRate: 115200, dataBits: 8, stopBits: 1, mode: "bidirectional" as const };
(async () => {
