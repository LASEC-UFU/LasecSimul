...
exports.accessories2 = exports.accessories = void 0;
const S = 1.5;
...
exports.accessories = [
    ...
    },
    {
        ...
        category: 'accessories',
        gridSize: { w: 2, h: 3 },
        render: () => `<circle cx="8" cy="8" r="7" fill="none" stroke="currentColor" stroke-width="${S}"/>` +
            path('M8 8 L12 4') +
            path('M8 15 V24'),
...
const circle2 = (cx, cy, r) => `<circle cx="${cx}" cy="${cy}" r="${r}" fill="none" stroke="currentColor" stroke-width="1.5"/>`;
const path2 = (d) => `<path d="${d}" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>`;
const text2 = (x, y, t) => `<text x="${x}" y="${y}" font-size="8" font-family="sans-serif" text-anchor="middle" fill="currentColor" stroke="none">${t}</text>`;
exports.accessories2 = [
    {
        id: 'acc.bulb',
    ...
    },
    {
        ...
        category: 'accessories',
        gridSize: { w: 2, h: 3 },
        render: () => circle2(8, 8, 7) + path2('M8 8 L11 4') +
    ...
    },
    {
        ...
        category: 'accessories',
        gridSize: { w: 3, h: 5 },
        render: () => path2('M4 4 h16 v32 h-16 Z') + circle2(12, 20, 4) +
