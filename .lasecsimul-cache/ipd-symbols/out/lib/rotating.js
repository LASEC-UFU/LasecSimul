...
exports.rotating2 = exports.rotating = void 0;
const S = 1.5;
...
const text = (x, y, t, size = 10) => `<text x="${x}" y="${y}" font-size="${size}" font-family="sans-serif" text-anchor="middle" fill="currentColor" stroke="none">${t}</text>`;
exports.rotating = [
    {
        id: 'pump.centrifugal',
    ...
    },
    {
        ...
        category: 'rotating',
        gridSize: { w: 4, h: 6 },
        render: () => path('M10 0 h12 v10 h-12 Z') +
            path('M16 10 V40') +
...
exports.rotating2 = [
    {
        ...
        category: 'rotating',
        gridSize: { w: 4, h: 4 },
        render: () => circle(16, 16, 14) + circle(16, 8, 3) + circle(9, 21, 3) + circle(23, 21, 3) +
            path('M0 16 H2 M30 16 H32'),
        ports: [
            { id: 'w', x: 0, y: 16, kind: 'process' },
            { id: 'e', x: 32, y: 16, kind: 'process' },
    ...
    },
    {
        ...
        category: 'rotating',
        gridSize: { w: 3, h: 5 },
        render: () => path('M4 8 a8 6 0 0 1 16 0 V34 a8 6 0 0 1 -16 0 Z') +
    ...
    },
    {
        ...
        category: 'rotating',
        gridSize: { w: 6, h: 3 },
        render: () => path('M0 4 h28 v16 h-28 Z') + path('M8 12 H20 M14 8 V16') + path('M28 12 H36') + circle(40, 12, 6),
        ports: [
            { id: 'w', x: 0, y: 12, kind: 'process' },
