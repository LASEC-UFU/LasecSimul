...
exports.heat2 = exports.heat = void 0;
const S = 1.5;
...
exports.heat = [
    ...
    },
    {
        ...
        category: 'heat',
        gridSize: { w: 4, h: 4 },
        render: () => path('M2 2 h28 v28 h-28 Z') +
    ...
    },
    {
        ...
        category: 'heat',
        gridSize: { w: 8, h: 4 },
        render: () => path('M0 8 h64 v24 h-64 Z') +
            circle(32, 20, 8) +
...
const text2 = (x, y, t, size = 8) => `<text x="${x}" y="${y}" font-size="${size}" font-family="sans-serif" text-anchor="middle" fill="currentColor" stroke="none">${t}</text>`;
exports.heat2 = [
    {
        id: 'hx.kettle',
        ...
        category: 'heat',
        gridSize: { w: 10, h: 6 },
        render: () => path('M12 8 H68 a10 14 0 0 1 0 28 H12 a10 14 0 0 1 0 -28 Z') +
    ...
    },
    {
        ...
        category: 'heat',
        gridSize: { w: 7, h: 9 },
        render: () => path('M0 16 h56 v48 h-56 Z') +
    ...
    },
    {
        ...
        category: 'heat',
        gridSize: { w: 6, h: 6 },
        render: () => `<circle cx="24" cy="16" r="14" fill="none" stroke="currentColor" stroke-width="1.5"/>` +
    ...
    },
    {
        ...
        category: 'heat',
        gridSize: { w: 8, h: 7 },
        render: () => path('M8 0 L56 0 L48 48 L16 48 Z') +
