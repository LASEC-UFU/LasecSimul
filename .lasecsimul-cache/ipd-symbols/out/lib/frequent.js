...
const text = (x, y, t, size = 7) => `<text x="${x}" y="${y}" font-size="${size}" font-family="sans-serif" text-anchor="middle" fill="currentColor" stroke="none">${t}</text>`;
...
exports.frequentItems = [
    ...
    },
    {
        ...
        category: 'valves',
        gridSize: { w: 2, h: 3 },
        render: () => path('M8 0 V6') + path('M2 6 H14') + path('M2 6 L14 6 L8 15 Z') +
    ...
    },
    {
        ...
        category: 'valves',
        gridSize: { w: 4, h: 2 },
        render: () => path('M4 2 L28 8 L4 14 Z') + circle(11, 8, 4) + path('M28 0 V16'),
        ports: [
    ...
    },
    {
        ...
        gridSize: { w: 2, h: 3 },
        render: () => path('M2 0 H14 V12 H2 Z') + path('M2 12 L14 0') +
