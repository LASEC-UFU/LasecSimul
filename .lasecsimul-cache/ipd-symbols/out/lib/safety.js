...
exports.safetyDevices = [
    {
        ...
        render: () => path('M4 40 L20 40 L12 24 Z') +
    ...
    },
    {
        ...
        render: () => path('M6 8 a10 8 0 0 1 20 0 Z') +
            path('M16 8 V24') +
...
const path2 = (d, fill = 'none') => `<path d="${d}" fill="${fill}" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>`;
...
exports.safetyDevices2 = [
    {
        id: 'psv.pilot',
        name: 'Pilot-Operated PSV',
        category: 'safety',
        gridSize: { w: 3, h: 5 },
        render: () => path2('M4 40 L20 40 L12 24 Z') +
    ...
    },
    {
        ...
        category: 'safety',
        gridSize: { w: 4, h: 5 },
        render: () => path2('M6 8 a10 8 0 0 1 20 0 Z') +
            path2('M16 8 V24') +
            `<g transform="translate(0 24)">` +
