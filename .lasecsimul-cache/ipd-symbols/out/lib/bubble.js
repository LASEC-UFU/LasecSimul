...
function locationLines(location) {
    switch (location) {
        ...
        case 'local-panel':
            return (`<line x1="2" y1="17.5" x2="38" y2="17.5" stroke="currentColor" stroke-width="${S}"/>` +
                `<line x1="2" y1="22.5" x2="38" y2="22.5" stroke="currentColor" stroke-width="${S}"/>`);
        default:
            return '';
    }
}
function displayShape(display) {
    ...
    switch (display) {
        ...
        case 'plc':
            return (`<rect x="2" y="2" width="36" height="36" fill="none" stroke="currentColor" stroke-width="${S}"/>` +
