...
exports.defaultComponentCatalog = void 0;
exports.createInitialWebviewState = createInitialWebviewState;
...
exports.defaultComponentCatalog = [
...
// plataforma/chip).
function createInitialWebviewState(catalog = exports.defaultComponentCatalog) {
    return {
        locale: "pt-BR",
        catalog,
        components: [],
