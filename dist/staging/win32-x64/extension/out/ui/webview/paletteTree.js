...
exports.resolvePaletteFolderPath = resolvePaletteFolderPath;
exports.buildPaletteTree = buildPaletteTree;
...
function resolvePaletteFolderPath(entry) {
...
function buildPaletteTree(entries, rawQuery) {
    const roots = [];
